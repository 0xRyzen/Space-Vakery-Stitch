    ...
    return (
        <div className="container mx-auto px-4 py-20">
            <div className="text-center mb-16">
                <h1 className="font-serif text-5xl mb-4">Our Showrooms</h1>
                <p className="opacity-60">Visit us in the physical realm.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                ...
                <GlassCard className="p-8">
                    <h2 className="font-serif text-2xl mb-4">The Stardust Studio</h2>
