...
export const Journal = () => {
    ...
    return (
        <div className="container mx-auto px-4 pb-12 sm:pb-16 md:pb-20">
            <PageHeader>
                <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl mb-4">The Cosmic Journal</h1>
                <p className="opacity-60 text-sm sm:text-base">Notes from the kitchen and beyond.</p>
            </PageHeader>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                {posts.map(post => (
                    <GlassCard key={post.id} className="group cursor-pointer overflow-hidden p-0 h-[400px] sm:h-[450px] md:h-[500px] relative">
                        <img
                            src={post.image}
                            alt={post.title}
                        ...
                        <div className="absolute bottom-0 left-0 w-full p-4 sm:p-6 md:p-8 text-white z-10">
